...
const THEMES: Record<string, BrandTheme> = {
  ...
  '2s': {
    // Deep teal-cyan — fintech clean, tecnologia financeira
    surface:       '#040E12',
    surfaceHero:   '#051218',
    luminous:      true,
    cardBg:        'linear-gradient(155deg, rgba(6,182,212,.05) 0%, #040E12 38%) padding-box, linear-gradient(135deg, rgba(6,182,212,.55) 0%, rgba(14,165,233,.22) 55%, rgba(6,182,212,.1) 100%) border-box',
    cardBgHero:    'linear-gradient(155deg, rgba(6,182,212,.08) 0%, #051218 38%) padding-box, linear-gradient(135deg, rgba(6,182,212,.70) 0%, rgba(14,165,233,.30) 50%, rgba(6,182,212,.14) 100%) border-box',
    cardBorder:    '1px solid transparent',
    cardBorderHero:'1px solid transparent',
    cardShadow:    'inset 0 0 50px rgba(6,182,212,.025), 0 0 0 0.5px rgba(6,182,212,.08)',
    cardShadowHero:'inset 0 0 70px rgba(6,182,212,.04), 0 0 0 0.5px rgba(6,182,212,.12)',
    border:        'rgba(6,182,212,.14)',
    borderHero:    'rgba(6,182,212,.25)',
    accent:        '#22D3EE',
    accent2:       '#0EA5E9',
    accentMuted:   'rgba(6,182,212,.07)',
    chartStroke:   '#06B6D4',
    chartGradStop: 'rgba(6,182,212,.22)',
    chartGradient: 'linear-gradient(90deg, #06B6D4, #0EA5E9)',
    numColor:      '#67E8F9',
    labelColor:    'rgba(103,232,249,.28)',
    bodyColor:     'rgba(103,232,249,.45)',
    doneTint:      '#34D399',
    doneBg:        'rgba(52,211,153,.09)',
    activeTint:    '#22D3EE',
    activeBg:      'rgba(34,211,238,.08)',
    warnTint:      '#67E8F9',
    warnBg:        'rgba(103,232,249,.07)',
    dangerTint:    '#F87171',
    dangerBg:      'rgba(248,113,113,.07)',
    avatarBg:      'rgba(6,182,212,.12)',
    avatarBorder:  'rgba(6,182,212,.28)',
    avatarText:    '#22D3EE',
    progressFill:  'linear-gradient(90deg, #06B6D4 0%, #0EA5E9 100%)',
    taskBorderHigh:'rgba(248,113,113,.7)',
    taskBorderMed: 'rgba(103,232,249,.5)',
    tipBg:         '#040C10',
    tipAccent:     '#22D3EE',
  },
};
